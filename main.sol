...
contract Bordeaux {
    ...
    function peekDest_14(uint256 destId) external view returns (
        uint32 reviews,
        uint32 scrapes,
        uint256 rep,
        uint8 tier,
    ...
    function peekDest_15(uint256 destId) external view returns (
        uint32 reviews,
        uint32 scrapes,
        uint256 rep,
        uint8 tier,
    ...
    function peekDest_16(uint256 destId) external view returns (
        uint32 reviews,
        uint32 scrapes,
        uint256 rep,
        uint8 tier,
    ...
    function peekDest_17(uint256 destId) external view returns (
        uint32 reviews,
        uint32 scrapes,
        uint256 rep,
        uint8 tier,
    ...
    function peekDest_18(uint256 destId) external view returns (
        uint32 reviews,
        uint32 scrapes,
        uint256 rep,
        uint8 tier,
    ...
    function peekDest_19(uint256 destId) external view returns (
        uint32 reviews,
        uint32 scrapes,
        uint256 rep,
        uint8 tier,
    ...
    function peekDest_20(uint256 destId) external view returns (
        uint32 reviews,
        uint32 scrapes,
        uint256 rep,
        uint8 tier,
    ...
    function peekDest_21(uint256 destId) external view returns (
        uint32 reviews,
        uint32 scrapes,
        uint256 rep,
        uint8 tier,
    ...
    function peekDest_22(uint256 destId) external view returns (
        uint32 reviews,
        uint32 scrapes,
        uint256 rep,
        uint8 tier,
    ...
    function peekDest_23(uint256 destId) external view returns (
        uint32 reviews,
        uint32 scrapes,
        uint256 rep,
        uint8 tier,
    ...
    function scrapeLane_1(bytes32 jobId) external view returns (
        uint256 destId,
        uint8 phaseRaw,
        uint16 conf,
        bytes32 urlHash
    ...
    function scrapeLane_2(bytes32 jobId) external view returns (
        uint256 destId,
        uint8 phaseRaw,
        uint16 conf,
        bytes32 urlHash
    ...
    function scrapeLane_3(bytes32 jobId) external view returns (
        uint256 destId,
        uint8 phaseRaw,
        uint16 conf,
        bytes32 urlHash
    ...
    function scrapeLane_4(bytes32 jobId) external view returns (
        uint256 destId,
        uint8 phaseRaw,
        uint16 conf,
        bytes32 urlHash
    ...
    function scrapeLane_5(bytes32 jobId) external view returns (
        uint256 destId,
        uint8 phaseRaw,
        uint16 conf,
        bytes32 urlHash
    ...
    function scrapeLane_6(bytes32 jobId) external view returns (
        uint256 destId,
        uint8 phaseRaw,
        uint16 conf,
        bytes32 urlHash
